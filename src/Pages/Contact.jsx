...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      submitData.append('_subject', 'Nova Mensagem do Portfolio Medeiross.dev');
      submitData.append('_captcha', 'false');
      submitData.append('_template', 'table');
      // URL da sua ThankYouPage
      submitData.append('_next', 'http://localhost:3000/obrigado'); // Alterar para produção depois
  ...
  return (
    <div className="px-[5%] sm:px-[5%] lg:px-[10%]">
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        ...
        >
          Caso tenha alguma dúvida, envie-me uma mensagem. Responderei em breve.
        </p>
      </div>
            ...
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <p className="text-gray-400">
                  Entre em contato, responderei em breve.
                </p>
              </div>
